...
user_input = input("Ahoj uživateli, zadej své jméno: věk: pohlaví: ")


with open('02_user.txt', 'w', encoding= "utf8") as file:
    file.write(user_input)
    print("Právě se zdárně vytvořil soubor, kde jsou bezpečně uložený Vaše GDPR")